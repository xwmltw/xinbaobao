...
@implementation WQSystemMessageCell{
    UILabel      *_timeLabel;
...
-(void)setModel:(WQSystemMessage *)model{
    _model = model;
...
-(void)onBtnClick:(UIButton *)btn{
    if (_delegate != nil && [_delegate respondsToSelector:@selector(WQSystemCustomBtnClicked:)]) {
        [_delegate WQSystemCustomBtnClicked:btn];
    }
}
