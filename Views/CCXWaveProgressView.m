...
@interface CCXWaveProgressView ()
@property (nonatomic, weak,readwrite) UIImageView *backgroundImageView;
@property (nonatomic, weak) CCXWaterWaveView *waterWaveView;
...
@implementation CCXWaveProgressView
...
{
    CCXWaterWaveView *waterWaveView = [[CCXWaterWaveView alloc]init];
...
- (void)layoutSubviews
{
    ...
    _explainLabel.frame = CGRectMake((viewWidth - explainLabelWidth)/2, CGRectGetMaxY(_numberLabel.frame)+15, explainLabelWidth, explainLabelHeight);
}
