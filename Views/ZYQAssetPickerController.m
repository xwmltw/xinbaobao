...
- (void)finishPickingAssets:(UIBarButtonItem *)sender
{
    ...
    if ([picker.delegate respondsToSelector:@selector(assetPickerController:currentViewController:didFinishPickingAssets:)])
        [picker.delegate assetPickerController:picker currentViewController: self didFinishPickingAssets:_indexPathsForSelectedItems];
}
