...
#import "WQMulti_MediaApprovementViewController.h"
...
@interface WQMulti_MediaApprovementViewController ()<UINavigationControllerDelegate, ZYQAssetPickerControllerDelegate,UIScrollViewDelegate>

@property (retain, nonatomic) NSMutableArray *DataSource;

@end

@implementation WQMulti_MediaApprovementViewController{
...
-(void)createView{
    ...
    NSMutableAttributedString *noteStr = [[NSMutableAttributedString alloc] initWithString:@"选填: 可补充上传相关照片(例:学校、宿舍等)，完善度越高，总额度就越高。"];
